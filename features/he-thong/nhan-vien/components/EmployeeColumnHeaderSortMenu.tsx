...
import { EmployeeColumnHeaderSortButtons } from './EmployeeColumnHeaderSortButtons';

/**
 * Chỉ sắp xếp A–Z / Z–A (cột không có lọc giá trị).
 * Quy tắc listview: mọi cột hiển thị đều có nút thao tác (sliders); cột có filter dùng `EmployeeColumnHeaderFilter`.
 */
export function EmployeeColumnHeaderSortMenu({
  ariaLabel,
  sortColumnId,
  sort,
  setSort,
    ...
    <MultiSelect
      ...
      dropdownTopContent={({ close }) => (
        <div className="flex flex-col gap-2">
          <EmployeeColumnHeaderSortButtons
